  ...
  implements Listener
{
  ...
  protected boolean isVisible(Player observer, int entityID)
  {
    ...
    return presence ? false : this.policy == Policy.WHITELIST ? presence : true;
  }
  
  public void removeEntity(Entity entity, boolean destroyed)
  {
    int entityID = entity.getEntityId();
    for (Map<Integer, Boolean> maps : this.observerEntityMap.rowMap().values()) {
